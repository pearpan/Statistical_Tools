...
shinyServer(function(input, output){
  ...
  output$traditional_test <- renderPrint({    
    ...
    isolate({
      ...
      if(test_type=='two sample proportion test'){
        ...
        if (is.na(inFile)){
          testdata <- read.csv('StatisticalTest/data/test_data.csv',header=TRUE)
        }else{
        ...
        if (is.na(inFile)){
          controldata <- read.csv('StatisticalTest/data/control_data.csv',header=TRUE)
        }else{
  ...
  output$testcontents <- renderTable({
    ...
    if(input$TestType=='two sample proportion test'){
      ...
      inFile <- input$testfile
      if (is.na(inFile)){
        head(testdata <- read.csv('StatisticalTest/data/test_data.csv',header=TRUE))
      }else{
  ...
  output$controlcontents <- renderTable({
    ...
    if(input$TestType=='two sample proportion test'){
      ...
      if (is.na(inFile)){
        head(controldata<-read.csv('StatisticalTest/data/control_data.csv',header=TRUE))
      }else{
